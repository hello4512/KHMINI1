...
public class OpenPage extends JPanel{
	private MainFrame mf;
	private JPanel mainPage;
	private Image img;
	
	public OpenPage(MainFrame mf) {
		this.mf = mf;
		this.mainPage = this;
		...
		// JLabel "no."
		JLabel nojl = new JLabel("no.");
		upPanel.add(nojl);
		nojl.setFont(new Font("고딕", Font.BOLD, 30));
		nojl.setForeground(Color.white);
		nojl.setPreferredSize(new Dimension(540, 60));
		...
		JLabel usagetime = new JLabel("사용시간 : ");
